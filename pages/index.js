...
export default function Home() {
  ...
  return (
    <div className={darkMode ? 'dark' : ''}>
      <Head>
        <title>Attinder Singh Portfolio</title>
      ...
      <main className='bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40'>
        <section className=' min-h-screen'>
          <nav className='py-10 mb-12 flex justify-between  dark:text-white'>
            <h1 className='text-xl font-burtons'>Developed by Attinder</h1>
            <ul className='flex items-center'>
              <li>
                <BsFillMoonStarsFill
                  onClick={() => setDarkMode(!darkMode)}
                  className='cursor-ponter text-2xl'
                />
              </li>
            </ul>
          </nav>
          <div className='text-center p-10'>
            ...
            <p className='text-md py-5 leading-8 text-gray-800 md:text-xl max-w-xl mx-auto dark:text-gray-200'>
              My name is Attinder and I'm a Front End Developer from Australia.
        ...
        <section>
          ...
          <div className='lg:flex gap-10'>
            ...
            <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1'>
              ...
              <p className='text-gray-800 py-1'>HTML5 / CSS3 / React</p>
            ...
            <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1'>
              <Image
                ...
                height={100}
              />
              <h3 className='text-lg font-medium pt-8 pb-2 '>Deploying</h3>
              <p className='py-2'>
                I have deployed the websites using various services.
              </p>
              <h4 className='py-4 text-teal-600'>Services</h4>
              <p className='text-gray-800 py-1'>Netlify</p>
              <p className='text-gray-800 py-1'>AWS Amplify / S3 </p>
